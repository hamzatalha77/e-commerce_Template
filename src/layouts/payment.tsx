        ...
        <Page size="A4" style={tw('bg-[#FFFFFF]')}>
          ...
          <View style={tw(' w-full px-2 my-1')}>
            <View style={tw(' bg-[#F3F4F8] w-full rounded-2xl py-4 px-1 my-1')}>
              <View style={tw('pb-1 pt-1')}>
                <Svg
                  style={{ width: '100', height: '18', margin: 'auto' }}
                  viewBox="0 0 100 18"
                  fill="none"
                >
                  <Path
              ...
              <Table style={tw('bg-white rounded-2xl border-[#F3F4F8]')}>
                <TH style={tw('')}>
                  ...
                  <TD
                    style={tw(
                      'text-[8.7px] text-[#6B7280] font-bold py-3 pl-3 border-l-[#FFFFFF]'
                    )}
                  >
                    Date d’intervention
                  </TD>
                  <TD
                    style={tw(
                      'text-[8.7px] text-[#6B7280] font-bold py-3 pl-3 border-l-[#FFFFFF] border-r-[#FFFFFF]'
                    )}
                  >
                    Demandé par
                  </TD>
                ...
                <TR style={tw('')}>
                  ...
                  <TD
                    style={tw(
                      'text-[8.7px] text-[#6B7280] font-normal py-3 pl-3 border-l-[#FFFFFF]'
                    )}
                  >
                    29/04/204
                  </TD>
                  <TD
                    style={tw(
                      'text-[8.7px] text-[#6B7280] font-normal py-3 pl-3 border-l-[#FFFFFF] border-r-[#FFFFFF]'
                    )}
                  >
                    Hamid Folan
                  </TD>
                  <TD
                    style={tw(
                      'text-[8.7px] text-[#6B7280] font-normal py-3 pl-3 border-r-[#FFFFFF] border-l-[#FFFFFF]'
                    )}
                  >
                    Commercial
                  </TD>
            ...
            <View style={tw(' bg-[#F3F4F8] w-full rounded-2xl py-4 px-1 mt-1')}>
              <Table style={tw('bg-white rounded-2xl border-[#F3F4F8]')}>
                ...
                <TR style={tw('')}>
                  ...
                  <TD
                    style={tw(
                      'text-[8.7px] text-[#6B7280] font-normal py-12 pl-3 border-l-[#FFFFFF]'
                    )}
                  >
          ...
          <View style={tw('flex flex-row  gap-4 justify-around')}>
            <View style={tw('my-2')}>
              ...
              <Text
                style={tw(
                  'text-[8.95px] font-bold text-black text-center mx-3'
                )}
              >
                Nabil Netman
              </Text>
